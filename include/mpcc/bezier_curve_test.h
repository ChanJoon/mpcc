#ifndef INCLUDE_MPCC_BEZIER_CURVE_TEST_H_
#define INCLUDE_MPCC_BEZIER_CURVE_TEST_H_
...
class BEZIER_TEST {
 public:
  ...
  explicit BEZIER_TEST(const ros::NodeHandle& n_private) : nh(n_private) {
...
#endif  // INCLUDE_MPCC_BEZIER_CURVE_TEST_H_
